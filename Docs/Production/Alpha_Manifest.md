...
| C04 WesternFOB -> EasternDepot | Candidate; Resupply family personnel/supply corridor. Strategic endpoints span the four-edge chain above, not an adjacent convoy edge; physical delivery requires separate verification. | Existing cargo/resupply/transport systems; route production owner unknown. | Reachable staging/delivery sites, cargo vehicle, casualty handling and persisted resources. | Inventory records playable cargo/resupply foundations and authoritative watercraft delivery. | Next Q5 focus is read-only inventory of the actual boat/route, authored cargo, existing WesternFOB/EasternDepot stations, and geometry. Existing helper station-spawn/teleport proves transfer integration only, not authored corridor or destination supply delta; no Q5 pass/failure or production defect established. No map save/spawn/teleport/automatic repair is authorized by that finding. Natural boarding/travel/delivery/recovery, road/water choice, save/reload, and no supply dead end remain open. |
